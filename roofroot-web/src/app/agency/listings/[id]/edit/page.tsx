...
function AgencyEditListingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiClient.updateListing(listingId, form);
      if (response.success) {
        toast.success('Listing updated successfully');
        router.push(`/agency/listings/${listingId}`);
      } else {
...
export default withAgencyGuard(AgencyEditListingPage);
